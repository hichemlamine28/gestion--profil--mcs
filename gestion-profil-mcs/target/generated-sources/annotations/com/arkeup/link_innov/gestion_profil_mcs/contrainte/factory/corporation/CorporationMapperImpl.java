...
public class CorporationMapperImpl implements CorporationMapper {
    ...
    @Override
    public CorporationDTO corporationToCorporationDTO(Corporation corporation) {
        if ( corporation == null ) {
            return null;
        }
    ...
    @Override
    public Corporation corporationDTOToCorporation(CorporationDTO corporationDTO) {
    ...
    @Override
    public List<CorporationDTO> corporationToCorporationDTOs(List<Corporation> corporations) {
        if ( corporations == null ) {
            return null;
        }

        List<CorporationDTO> list = new ArrayList<CorporationDTO>( corporations.size() );
        for ( Corporation corporation : corporations ) {
            list.add( corporationToCorporationDTO( corporation ) );
        }
    ...
    @Override
    public List<Corporation> corporationDTOToCorporations(List<CorporationDTO> corporationDTOs) {
        if ( corporationDTOs == null ) {
            return null;
        }

        List<Corporation> list = new ArrayList<Corporation>( corporationDTOs.size() );
        for ( CorporationDTO corporationDTO : corporationDTOs ) {
            list.add( corporationDTOToCorporation( corporationDTO ) );
        }
