...
import com.arkeup.link_innov.gestion_profil_mcs.contrainte.errors.XSSInjectionException;
        ...
        if (value != null) {
            ...
            for (Pattern scriptPattern : patterns){
                if (scriptPattern.matcher(value).matches()) {
					throw new XSSInjectionException(new UnknownErrorDTO(), ErrorsEnum.ERR_MCS_XSS_INJECTION);
				}
            }
        }
        return value;
