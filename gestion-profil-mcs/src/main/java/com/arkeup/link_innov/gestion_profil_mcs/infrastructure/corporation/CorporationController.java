...
public class CorporationController {
    ...
    public CorporationDTO setCorporationHasMedia(
            @ApiParam(name = "CorporationHasMediaDTO",
                    value = "{\"corporationId\":\"ureturn corporationCUDSA.setCorporationHasMedia(corporationHasMediaDTO);uid\", \"hasMedia\":\"true\"}", required = true)
            @RequestBody CorporationHasMediaDTO corporationHasMediaDTO) {
