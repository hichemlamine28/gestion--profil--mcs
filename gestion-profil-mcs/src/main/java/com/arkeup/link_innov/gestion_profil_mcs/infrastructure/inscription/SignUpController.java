...
import com.arkeup.link_innov.gestion_profil_mcs.contrainte.errors.*;
...
public class SignUpController {
    ...
    public ProfilDTO signUp(
            @ApiParam(
                    name = "SignUpDTO",
                    value = "{\"language\": \"fr\",\"lastName\": \"DeLaFuente\", \"firstName\": \"Jean\", \"mail\": \"abc@yopmail.com\", \"employer\": { \"id\": \"employer_id\", \"name\": \"Universite de France\" }, \"type\": { \"id\": \"uuid-category-academique\", \"name\":\"Académique\", \"male\":\"true\"}}",
                    required = true)
    ...
    public RegistrationDTO checkoutRegistration(
    ...
    public ProfilDTO researchGateExtract(@ApiParam(name = "UserAuthDTO",
            value = "{\"username\": \"tata@toto.titi\", \"password\": \"passwordTest\"}",
            required = true) @Valid @RequestBody UserAuthDTO userAuthDTO, Errors errors) {
    ...
    public ProfilDTO register(
            @ApiParam(
                    name = "InscriptionDTO",
                    value = "{\"language\": \"fr\",\"lastName\": \"DeLaFuente\", \"firstName\": \"Jean\", \"mail\": \"abc@yopmail.com\", \"employer\": { \"id\": \"employer_id\", \"name\": \"Universite de France\" }, \"type\": { \"id\": \"uuid-category-academique\", \"name\":\"Académique\", \"male\":\"true\", \"profession\":\"Chercheur\"}",
                    required = true)
            @RequestPart(name = "inscriptionDTO", required = true) @RequestBody InscriptionDTO inscriptionDTO) {
    ...
    public IsImportedDTO importBetaTest(@ApiParam(name = "file", value = "{\"file\":\"Multipart file\"}", required = false)
    ...
    public IsMailSendDTO reSendMailValidate(
    ...
    public ProfilDTO importBetaTestInLandingPage(@ApiParam(
            name = "SignUpDTO",
            value = "{\"language\": \"fr\",\"lastName\": \"DeLaFuente\", \"firstName\": \"Jean\", \"mail\": \"abc@yopmail.com\", \"employer\": { \"id\": \"employer_id\", \"name\": \"Universite de France\" }, \"type\": { \"id\": \"uuid-category-academique\", \"name\":\"Académique\", \"male\":\"true\"}}",
            required = true) @RequestBody SignUpDTO signUpDTO) {
