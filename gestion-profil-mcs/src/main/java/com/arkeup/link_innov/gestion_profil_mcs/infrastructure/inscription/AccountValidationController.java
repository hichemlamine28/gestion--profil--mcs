...
public class AccountValidationController {
    ...
    public UserAuthDTO choosePassword(@ApiParam(name = "UserAuthDTO",
            value = "{\"username\": \"uuid\", \"password\": \"passwordTest\"}",
    ...
    @PreAuthorize("#userAuthDTO.username == principal.username") // Un utilisateur ne peux modifier que son propre mot de passe
    ...
    public UserAuthDTO changePassword(@ApiParam(name = "UserAuthDTO",
            value = "{\"username\": \"uuid\", \"password\": \"passwordTest\"}",
            required = true) @Valid @RequestBody UserAuthDTO userAuthDTO, Errors errors) {
    ...
    public UserAuthDTO passwordRecovery(@ApiParam(name = "UserAuthDTO", value = "{\"language\": \"fr\",\"mail\": \"email\"}",
            required = true) @RequestBody UserAuthDTO userAuthDTO) {
    ...
    public UserAuthDTO changeMail(@ApiParam(name = "UserAuthDTO",
            value = "{\"username\": \"uuid\", \"mail\": \"mail@mail.fr\"}",
            required = true) @RequestBody UserAuthDTO userAuthDTO) {
    ...
    public UserAuthDTO validateAccount(@ApiParam(name = "UserAuthDTO",
            value = "{\"username\": \"uuid\"}",
            required = true) @RequestBody UserAuthDTO userAuthDTO) {
